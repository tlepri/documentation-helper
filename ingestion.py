...
# Configure SSL context to use certifi certificates for Tavily
ssl_context = ssl.create_default_context(cafile=certifi.where())
os.environ["SSL_CERT_FILE"] = certifi.where()
os.environ["REQUESTS_CA_BUNDLE"] = certifi.where()

# Initialize OpenAI embeddings, the show progress bar is false if true shows a progress bar
...
# Chroma vector store, instead initializing pinecone vector store to use created index
...
tavily_crawl = TavilyCrawl()
    ...
    # coroutine to index documents asynchronously
...
# boilerplate code to orchestrate the entire process
async def main():
